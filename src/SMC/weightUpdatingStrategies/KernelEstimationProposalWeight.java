...
public class KernelEstimationProposalWeight extends WeightUpdatingStrategy
{
	...
	public void updateKernel(int sampleNumberForEstimation, KernelFunction kernelFunction, BigDecimal bandWidth) {
		this.sampleNumberForEstimation = sampleNumberForEstimation;
		this.kernelFunction = kernelFunction;
		this.bandWidth = bandWidth;
	}
	...
	@Override
	protected void updateUnnormalizedWeights(List<Particle> particleSet, AbstractMeasurement measurement, SamplingStrategy proposalSampler)
	{
		try
		{
